...
const MenuItem = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-1 flex h-9 cursor-pointer items-center rounded-lg transition-all duration-150 relative",
...
export default function Sidebar({
  ...
  return (
    ...
    <motion.aside 
      ...
      className={cn(
        "fixed left-0 top-0 z-[200] h-screen border-r border-[#1E293B] bg-[#0F172A] font-inter text-[#F1F5F9] transition-all duration-300 ease-in-out flex flex-col",
        "lg:translate-x-0",
        isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
      )}
    >
      {/* SECTION 1 — LOGO */}
      <div className={cn("pb-1 pt-4 transition-all duration-300 px-3 relative")}>
          ...
          {!isCollapsed && (
            <>
              ...
              <button 
                ...
                className="ml-auto flex h-6 w-6 items-center justify-center rounded-md border border-[#1E293B] bg-[#1E293B]/50 text-[#475569] hover:text-white transition-all shadow-sm"
              >
      ...
      <div className="flex-1 overflow-y-auto pb-4 hide-scrollbar">
        {/* OVERVIEW */}
        {!isCollapsed && <div className="mb-1 mt-3 px-2 text-[10px] font-medium uppercase tracking-widest text-[#475569]">{t('common.overview')}</div>}
        ...
        <AnimatePresence>
          {currentProject && (
            ...
            >
              ...
              {!isCollapsed && <div className="mb-1 mt-4 px-2 text-[10px] font-medium uppercase tracking-widest text-[#475569]">{t('sidebar.projectManagement')}</div>}
        ...
        {sysRole === "ADMIN" && (
          <>
            {!isCollapsed && <div className="mb-1 mt-4 px-2 text-[10px] font-medium uppercase tracking-widest text-[#475569]">{t('sidebar.adminPanel')}</div>}
      ...
      <div className="mt-auto border-t border-[#1E293B] bg-[#0F172A] pt-4 pb-6">
        {!isCollapsed && (
          <motion.div 
            ...
            className="mx-3 mb-4 rounded-xl border border-purple-500/30 bg-purple-500/5 p-3 group"
          >
