...
function LoginFormContent() {
    ...
    const handleAuthSuccess = async (res: any, fallbackMessage: string) => {
        if (res.data) {
    ...
    const mutation = useMutation({
        mutationFn: (data: LoginFormValues) => AuthService.loginNext({ ...data, turnstileToken }),
        onSuccess: async (res: any) => handleAuthSuccess(res, "Login successful!"),
        onError: (error: any) => {
