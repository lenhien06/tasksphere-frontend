  ...
  return (
    <article className="rounded-[15px] border border-slate-200 bg-white p-3.5 shadow-[0_12px_36px_rgba(15,23,42,0.05)] transition-all hover:-translate-y-1 hover:shadow-[0_18px_44px_rgba(15,23,42,0.08)]">
      <div className="flex items-start justify-between gap-4">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <button
              ...
              className="truncate text-left text-[20px] font-bold tracking-tight text-slate-950 hover:text-blue-700"
            >
              {workspace.name}
            </button>
        ...
        <div className="flex min-w-[100px] items-center justify-between gap-3 rounded-[11px] border border-slate-200 bg-slate-50 px-3 py-2">
      ...
      <div className="mt-3.5 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 whitespace-nowrap rounded-[12px] bg-slate-950 px-3.5 py-2 text-[13px] font-semibold text-white transition hover:bg-blue-700"
        >
          Open health view
