...
export default function WorkspaceHealthCard({
  ...
  return (
    <article className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-[0_12px_36px_rgba(15,23,42,0.05)] transition-all hover:-translate-y-1 hover:shadow-[0_18px_44px_rgba(15,23,42,0.08)]">
      <div className="flex items-start justify-between gap-4">
        <div className="flex min-w-0 items-center gap-3">
          <Avatar className="h-12 w-12 rounded-[16px] border border-slate-200 bg-slate-50">
            <AvatarImage src={workspace.avatarUrl ?? undefined} alt={workspace.name} />
            <AvatarFallback className="rounded-[16px] bg-slate-100 text-sm font-bold text-slate-700">
      ...
      <div className="mt-5 rounded-[16px] border border-slate-100 bg-slate-50/80 p-4">
