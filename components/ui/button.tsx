...
export interface ButtonProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, 'placeholder'>, VariantProps<typeof buttonVariants> {
  selected?: boolean;
  asChild?: boolean;
}
...
const ButtonArrow = React.forwardRef<SVGSVGElement, ButtonArrowProps>(({ icon: Icon = ChevronDown, className, ref: _propRef, ...props }, _ref) => {
