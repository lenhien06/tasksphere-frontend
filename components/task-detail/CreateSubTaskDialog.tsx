        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogPortal>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    <div className="relative flex h-[min(780px,calc(100vh-2rem))] w-full max-w-[860px] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
                        ...
                        <div className="custom-scrollbar min-h-0 flex-1 space-y-3.5 overflow-y-auto px-6 py-4">
                            <div>
