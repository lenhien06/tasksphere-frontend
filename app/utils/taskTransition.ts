...
export const VALID_TRANSITIONS: Record<TaskStatus, TaskStatus[]> = {
    TODO:        ["TODO", "IN_PROGRESS", "TESTING", "IN_REVIEW", "DONE", "CANCELLED"],
    IN_PROGRESS: ["TODO", "IN_PROGRESS", "TESTING", "IN_REVIEW", "DONE", "CANCELLED"],
    TESTING:     ["TODO", "IN_PROGRESS", "TESTING", "IN_REVIEW", "DONE", "CANCELLED"],
    IN_REVIEW:   ["TODO", "IN_PROGRESS", "TESTING", "IN_REVIEW", "DONE", "CANCELLED"],
    DONE:        ["TODO", "IN_PROGRESS", "TESTING", "IN_REVIEW", "DONE", "CANCELLED"],
    CANCELLED:   ["TODO", "IN_PROGRESS", "TESTING", "IN_REVIEW", "DONE", "CANCELLED"],
}
...
export const STATUS_STYLES: Record<TaskStatus, { bg: string; text: string; dot: string }> = {
    ...
    IN_REVIEW:   { bg: "bg-amber-50", text: "text-amber-600", dot: "bg-amber-500" },
