...
const AI_BUTTON_CLASSNAME =
    "relative inline-flex items-center justify-center align-middle isolate overflow-hidden rounded-2xl border border-cyan-200/80 bg-[linear-gradient(135deg,#0f172a_0%,#1d4ed8_24%,#7c3aed_52%,#ec4899_78%,#f59e0b_100%)] px-4 py-2.5 text-sm font-bold leading-none text-white shadow-[0_0_0_1px_rgba(255,255,255,0.16)_inset,0_12px_30px_rgba(14,165,233,0.3),0_0_26px_rgba(168,85,247,0.24),0_0_52px_rgba(236,72,153,0.16)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.24)_inset,0_18px_40px_rgba(14,165,233,0.38),0_0_34px_rgba(168,85,247,0.3),0_0_64px_rgba(236,72,153,0.22)] before:absolute before:inset-[1px] before:rounded-[15px] before:bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.38),transparent_34%),linear-gradient(135deg,rgba(255,255,255,0.16),rgba(255,255,255,0.03))] before:content-[''] after:absolute after:-inset-x-10 after:top-0 after:h-full after:-skew-x-12 after:bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.3),transparent)] after:opacity-0 after:transition-opacity after:duration-300 after:content-[''] hover:after:opacity-100";
                ...
                <div className="flex flex-wrap items-center gap-2 overflow-x-auto rounded-xl border border-gray-200 bg-white p-2 shadow-sm">
                    ...
                    <div className="ml-auto flex items-center gap-2">
                        ...
                        <button
                            ...
                            className={cn(
                                AI_BUTTON_CLASSNAME,
                                "h-10 min-w-[154px] gap-2 px-4 font-semibold whitespace-nowrap"
                            )}
                        >
